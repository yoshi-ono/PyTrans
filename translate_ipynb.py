...
class TranslateIpynb(threading.Thread):
    def __init__(self, ipynb_file, thread_no) -> None:
        self.input_file = ipynb_file
    ...
    def name_output_file(self):
        ...
        target_str = "-translated-" + target + ".ipynb"
        output_file_1 = input_file_1.replace(".ipynb"[::-1], target_str[::-1], 1)
    ...
    def trans_box(self, text_box, trans_src) -> None:
            ...
            for cell in jsn['cells']:
                ...
                if (cell['cell_type'] == "markdown"):
                    ...
                    for line in cell['source']:
                        ...
                        if (tt['topic']):
                            if (text_box != ""):
                                self.trans_box(text_box, trans_src)
                                text_box = ""
                            if (tt['trans'] != ""):
